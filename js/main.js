...
$(function() {
  ...
  //json = "https://raw.githubusercontent.com/wakayama-pref-org/pr_magazine_event_2018_05/master/json/pr_magazine_event_2018_05.json";
});
...
.fail(function() {
  $.getJSON("https://raw.githubusercontent.com/wakayama-pref-org/pr_magazine_event_" + jyear + "_" + getMonth()-1 + "/master/json/pr_magazine_event_" + jyear + "_" + getMonth()-1 + ".json" , function(data) {
    len = data.length;
    console.log("json", data); //jsonの中身をコンソールで表示
    var event_array = [];
    for(var i = 0; i < len; i++) { //jsonの中身を取り出す
